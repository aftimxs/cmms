    ...
    return(
        <div className="progress-stacked" style={{background:'#e3e3e3'}}>
            <div className="progress" role="progressbar" aria-label="good"
                 aria-valuenow={progress[0]} aria-valuemin={0} aria-valuemax={100} style={{width: progress[0] ? `${progress[0]}%` : 0}}>
            ...
            <div className="progress" role="progressbar" aria-label="scrap"
                 aria-valuenow={progress[1]} aria-valuemin={0} aria-valuemax={100} style={{width: progress[1] ? `${progress[1]}%` : 0}}>
